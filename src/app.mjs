...
export const createApp = (service) => {
  ...
  app.post('/access-performance-allocation-reviews', (request, response, next) => {
    try {
  ...
  app.get('/access-performance-allocation-reviews/:id', (request, response, next) => {
    try {
  ...
  app.post('/access-performance-allocation-reviews/:id/:action', (request, response, next) => {
    try {
